          ...
          <p>
            <div className="flex items-center space-x-3 lg:space-x-4">
              <a
                ...
                target="_blank"
              >
                <WhatsApp className="w-10 text-[#25D366] cursor-pointer h-7 sm:h-8 md:hover:-translate-y-1 transition duration-200 ease-out" />
              </a>
              <a
                rel="noreferrer"
                ...
                target="_blank"
              >
                <Facebook className="w-10 text-[#008ad3] cursor-pointer h-7 sm:h-8 md:hover:-translate-y-1 transition duration-200 ease-out " />
              </a>
              <a
                rel="noreferrer"
                ...
                target="_blank"
              >
                <LinkedIn className="w-10 text-[#00a0dc] cursor-pointer h-7 sm:h-8 md:hover:-translate-y-1 transition duration-200 ease-out" />
              </a>
              <a
                target="_blank"
                rel="noreferrer"
              ...
              >
                <GitHub className="w-10 text-[#fff]  cursor-pointer h-7 sm:h-8 md:hover:-translate-y-1 transition duration-200 ease-out" />
              </a>
            </div>
          </p>
        </div>
